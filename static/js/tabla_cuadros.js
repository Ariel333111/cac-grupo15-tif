const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://ariel111222.pythonanywhere.com/cuadros", // Retorna todos los registro de la tabla productos
        cuadros:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://ariel111222.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
