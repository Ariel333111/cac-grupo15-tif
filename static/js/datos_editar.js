...
for (const [nombre, valor] of datos) {
    ...
    resultado[ancho] = valor
    resultado[largo] = valor
...
document.getElementById("ancho").value = resultado["ancho"]
document.getElementById("largo").value = resultado["largo"]
document.getElementById("imagen").value = resultado["imagen"]
document.getElementById("estilo").value = resultado["estilo"]